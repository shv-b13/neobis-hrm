    ...
    render() {
        return (
            <div>
                ...
                <span className='headerforpers'>
                        Recruitment
                    </span>
                <span className="headrecrutment">
                    <span className="headdeadline">ДЭДЛАЙН: </span>
                    <span className="headday">20 апреля 12:00</span>
                </span>

                <p class='headtext'> Recruitment can refer to processes involved in choosing individuals for unpaid
                    roles.
                ...
                <div>
                    ...
                    <button onClick={() => {
                        ...
                        document.getElementsByClassName("button_back")[0].style.visibility = 'visible';
                    }} class="button_next">ДАЛЕЕ
                    </button>
                    <button onClick={() => {
                        document.getElementsByClassName("about_you")[0].style.visibility = 'hidden';
                        document.getElementsByClassName("button_next")[0].style.visibility = 'visible';
                        ...
                        document.getElementsByClassName("block1")[0].style.background = '#32B482';
                        document.getElementsByClassName("block_text")[0].style.color = '#FFFFFF';
                        document.getElementsByClassName("block_text1")[0].style.color = '#E6E6E6';
                        document.getElementsByClassName("button_back")[0].style.visibility = 'hidden';
                    }} className="button_back">НАЗАД
                    </button>
                    <button onClick={() => {
                        document.getElementsByClassName("about_you")[0].style.visibility = 'hidden';
                        ...
                        document.getElementsByClassName("button_back")[0].style.visibility = 'hidden';
                        document.getElementsByClassName("button_backto")[0].style.visibility = 'visible';
                    ...
                    <button onClick={() => {
                        ...
                        document.getElementsByClassName("button_nextto")[0].style.visibility = 'visible';
                        document.getElementsByClassName("button_send")[0].style.visibility = 'hidden';
                        document.getElementsByClassName("block3")[0].style.background = '#FFFFFF';
                        document.getElementsByClassName("block2")[0].style.background = '#32B482';
                        document.getElementsByClassName("block_text1")[0].style.color = '#FFFFFF';
                        document.getElementsByClassName("block_text2")[0].style.color = '#E6E6E6';
                        document.getElementsByClassName("button_back")[0].style.visibility = 'visible';
                        document.getElementsByClassName("button_backto")[0].style.visibility = 'hidden';
                    }} className="button_backto">НАЗАД
                    </button>
